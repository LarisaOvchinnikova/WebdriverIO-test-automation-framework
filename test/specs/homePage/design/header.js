...
describe('Home page - Design', () => {
    ...
    it('verify that Register button has correct text-color', () => {
        const actualColor = $(registerButton).getCSSProperty('color').parsed.hex.toLowerCase();
    ...
    it('verify that Register button has correct border-color', () => {
        const borderColor = $(registerButton).getCSSProperty('border-color').parsed.hex.toLowerCase();
